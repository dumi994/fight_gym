     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <!--  <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
             <li class="nav-item">
               <a href="/dashboard/trainers" class="nav-link">
                 <i class="far fa-circle nav-icon"></i>
                 <p>Tutti gli allenatori</p>
               </a>
             </li>
             <li class="nav-item">
               <a href="{{route('trainers.create')}}" class="nav-link">
                 <i class="far fa-circle nav-icon"></i>
                 <p>Assegna un corso</p>
               </a>
             </li>
         ...
         <li class="nav-item has-treeview">
           ...
           <ul class="nav nav-treeview">
             ...
             <li class="nav-item">
               <a href="/dashboard/students/create" class="nav-link">
                 <i class="far fa-circle nav-icon"></i>
         ...
         <!-- PRESENZE -->
         <li class="nav-item has-treeview">
           <a href="/dashboard/attendances" class="nav-link">
